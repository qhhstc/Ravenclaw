...
export default function OrderListPage() {
  ...
  const columns: ColumnsType<OrderRecord> = [
    ...
    { title: "毛利", dataIndex: "grossProfit", width: 130, align: "right", render: (value, row) => <span className={Number(value) < 0 ? "font-semibold text-red-500" : ""}>{moneyText(value, row.baseCurrency || "CNY")}</span> },
