...
export default function OrderStatsCards({ stats }: { stats: OrderStatsData }) {
  const cards = [
    ...
    { title: "本月订单金额（本位币）", value: compactMoneyText(stats.monthTotalAmount, "CNY"), tag: "金额", color: "cyan" },
    { title: "本月已收金额（本位币）", value: compactMoneyText(stats.monthPaidAmount, "CNY"), tag: "已收", color: "green" },
    { title: "本月未收金额（本位币）", value: compactMoneyText(stats.monthUnpaidAmount, "CNY"), tag: "未收", color: "orange" },
