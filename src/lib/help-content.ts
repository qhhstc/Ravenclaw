...
const helpByRoute: Record<string, HelpContent> = {
  ...
  "/products": {
    ...
    sections: [
      ...
      { title: "成本关系", items: ["默认采购单价和默认包装成本会作为订单商品成本的参考值，默认按 CNY 维护。", "订单里仍可按实际情况调整采购单价、包装单价、币种和汇率。"] },
    ],
  ...
  "/orders": {
    ...
    quickStart: ["点击新增订单，填写客户、业务员、订单币种、汇率和订单基础信息。", "在商品明细表选择产品，录入数量、销售单价、采购单价、包装单价及对应成本币种。", "保存订单后可继续维护成本分项、状态记录和附件。", "订单附件建议上传提单、装箱单、报关单、聊天记录等关键资料。"],
    sections: [
      { title: "利润核算", items: ["销售额按订单币种记录，并按订单汇率换算成本位币。", "采购成本、包装成本和其他费用按各自币种/汇率换算成本位币。", "订单毛利 = 销售本位币 - 商品采购成本本位币 - 包装成本本位币 - 其他成本本位币。"] },
