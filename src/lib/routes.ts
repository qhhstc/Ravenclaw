...
export const appRoutes: AppRoute[] = [
  ...
  { path: "/products", title: "产品库", menuLabel: "产品库", icon: createElement(ProductOutlined) },
  { path: "/orders", title: "订单中心", menuLabel: "订单中心", icon: createElement(OrderedListOutlined) },
  { path: "/reports/profit", title: "利润报表", menuLabel: "利润报表", icon: createElement(DollarOutlined) },
  ...
  { path: "/settings/system", title: "账号管理", menuLabel: "账号管理", icon: createElement(SettingOutlined) },
];
